      ...
      <div className="main bg-[#F2F2F2] px-4 py-4">
        <div className="flex flex-wrap place-content-center   ">
          <div className="flex-col gap-y-2">
            <div className="card flex  items-center rounded-lg bg-[#E6E8E9] pl-8 pt-4">
          ...
          <div className="monolith-card bg-[#E6E8E9]">
            <div className="title text-xl font-semibold">Power Bank</div>
            <div className="image w-60">
