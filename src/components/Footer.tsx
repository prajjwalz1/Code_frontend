  ...
  return (
    <footer className="footer w-full bg-gray-300 px-10 pb-4 pt-8">
      <div className="container mx-auto">
        <div className="grid place-items-center justify-items-center-center grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-3">
